...
// button group - load ASF/AMC/AMD data
Fl_Button * loadSkeleton_button = (Fl_Button *)0;
Fl_Button * loadMotion_button = (Fl_Button *)0;
Fl_Button * loadMassDistribution_button = (Fl_Button *)0;
...
Fl_Light_Button * compute_button = (Fl_Light_Button *)0;
...
Fl_Window * make_window() 
{
  ...
  { 
    Fl_Window * o = main_window = new Fl_Window(741, 622, "ASF/AMC Motion Capture Player");
	  //Fl_Window * o = main_window = new Fl_Window(800, 700, "ASF/AMC Motion Capture Player");
    w = o;
    { 
      Fl_Group * o = new Fl_Group(10, 485, 615, 140);
      { 
        Fl_Button * o = loadSkeleton_button = new Fl_Button(10, 495, 115, 40, "Load Skeleton");
        o->callback((Fl_Callback *)load_callback);
      }

      { 
        Fl_Button * o = loadMotion_button = new Fl_Button(140, 495, 115, 40, "Load Motion");
        o->callback((Fl_Callback *)load_callback);
      }

      // "Reload motion" always reload the last skeleton loaded
      { 
        Fl_Button * o = reloadMotion_button = new Fl_Button(270, 495, 115, 40, "Reload Motion");
        o->callback((Fl_Callback *)reload_callback);
      }

      {
    	  Fl_Button * o = loadMassDistribution_button = new Fl_Button(400, 495, 115, 40, "Load Mass Dist.");
    	  o->callback((Fl_Callback *)load_callback);
      }

      { 
        Fl_Button * o = resetScene_button = new Fl_Button(530, 495, 115, 40, "Reset Scene");
    ...
    {
    	Fl_Light_Button * o = compute_button = new Fl_Light_Button(650, 405, 85, 25, "Compute");
    	o->callback((Fl_Callback*)compute_callback, (void*)(0));
    	o->align(FL_ALIGN_INSIDE);
    }

    { 
      Fl_Button * o = aboutPlayer_button = new Fl_Button(650, 435, 85, 25, "About");
