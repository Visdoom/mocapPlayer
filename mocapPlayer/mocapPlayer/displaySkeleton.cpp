...
*/
  ...
  { 
	  ...
	  //draw red spheres where the local center of mass is

	  glPushMatrix();
	    glTranslatef(pBone->cm[0],pBone->cm[1],pBone->cm[2]);

	    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, (jointColors[1]));
