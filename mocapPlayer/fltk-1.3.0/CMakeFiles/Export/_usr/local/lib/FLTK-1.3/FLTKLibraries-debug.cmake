...
SET_TARGET_PROPERTIES(fltk_jpeg PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/libfltk_jpeg.a"
  )
...
SET_TARGET_PROPERTIES(fluid PROPERTIES
  IMPORTED_LOCATION_DEBUG "/usr/local/bin/fluid"
  )
...
SET_TARGET_PROPERTIES(fltk PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "-lpthread;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so"
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/libfltk.a"
  )
...
SET_TARGET_PROPERTIES(fltk_forms PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/libfltk_forms.a"
  )
...
SET_TARGET_PROPERTIES(fltk_images PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "fltk;/usr/lib/x86_64-linux-gnu/libpng.so;/usr/lib/x86_64-linux-gnu/libz.so;fltk_jpeg;/usr/lib/x86_64-linux-gnu/libz.so"
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/libfltk_images.a"
  )
...
SET_TARGET_PROPERTIES(fltk_gl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "fltk;/usr/lib/x86_64-linux-gnu/libGLU.so;/usr/lib/x86_64-linux-gnu/libGL.so;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so"
  IMPORTED_LOCATION_DEBUG "/usr/local/lib/libfltk_gl.a"
  )
